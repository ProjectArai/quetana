			...
			<div class="ContentsArea">
				<div class="ContentsShadow">
					<div class="ContentsFull">
						<input type="image" class="Button30 Right" src="/quetana/img/save.jpg">
						...
						<div class="TblBody">
							<textarea id="stDetails" class="FullWide" name="stIntroduction" placeholder="詳細" onFocus="dynamicHeightChanger('stDetails')"><%= stDetails %></textarea>
						</div>
					</div>
				</div>
			</div>
