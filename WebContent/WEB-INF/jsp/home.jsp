<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="model.TimeLineBean,java.util.List, java.util.ArrayList" %>
<%
//リクエストスコープからタイムラインを取得
List<TimeLineBean> arrTimeLine = (List<TimeLineBean>) request.getAttribute("arrTimeLine");
List<String> testList = (List<String>)request.getAttribute("testList");
%>
<!DOCTYPE html>
<html>
	<head>
	...
	<body onLoad="viewTimeLineTest(<%=  testList %>)">
